...
const long stdCode[NUM_STANDARDS] = { 199711L, 201103L, 201402L, 201703L, 202002L, 202302L, 202612L};
const char* stdName[NUM_STANDARDS] = { "Pre-C++11", "C++11", "C++14", "C++17", "C++20", "C++23", "C++26" };
...
int main(){
    ...
    if(standard == -1){
        std::cout << "Unable to determine your C++ standard." << std::endl;
        return 0;
    }
